...
export default function Home() {
  return (
    <main className={HOMECSS.main}>
      <section className={HOMECSS.section_bio}>
        <div className={HOMECSS.image_container}>
          <Image
            ...
            width={250} // Fixed: Use numbers instead of strings for width and height
            height={250} // Fixed: Use numbers instead of strings for width and height
      ...
      <div className={HOMECSS.app_cc}>©&nbsp;2025&nbsp;<a href="https://karthikshetty.info/" target="_blank">Karthik Shetty</a></div>
    </main>
  );
}